...
public class A extends Agent {
  ...
  @SyntheticMember
  public A(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public A(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public A(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
