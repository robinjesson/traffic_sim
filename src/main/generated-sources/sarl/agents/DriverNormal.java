...
public class DriverNormal extends Driver {
  ...
  @SyntheticMember
  public DriverNormal(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public DriverNormal(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public DriverNormal(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
